  ...
  return (
    <div className="h-full overflow-y-auto bg-background">
      <div className="px-5 pt-6 pb-4 text-center">
        ...
        <h1 className="text-xl font-bold text-white mt-3">{user?.full_name || "Chillcharge User"}</h1>
      ...
      <div className="px-5 grid grid-cols-3 gap-2.5">
        <div className="glass rounded-2xl p-3 text-center">
          ...
          <div className="text-[10px] text-white/40">Charges</div>
        </div>
        <div className="glass rounded-2xl p-3 text-center">
      ...
      <div className="px-5 mt-5 space-y-2.5">
        <button onClick={() => navigate("/saved")} className="w-full glass rounded-2xl p-4 flex items-center justify-between active:scale-98 transition">
          <span className="flex items-center gap-3 text-white text-sm font-medium"><Bookmark className="w-4 h-4 text-cyan-300" /> Saved stations</span>
        </button>
        <button onClick={() => navigate("/settings")} className="w-full glass rounded-2xl p-4 flex items-center justify-between active:scale-98 transition">
          <span className="flex items-center gap-3 text-white text-sm font-medium"><User className="w-4 h-4 text-cyan-300" /> Settings</span>
        </button>
