...
export default function iPhoneFrame({ children }) {
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-neutral-900 to-black flex items-center justify-center sm:p-4">
      ...
      <div className="w-full sm:w-[390px] sm:h-[min(844px,90vh)] sm:rounded-[3.2rem] sm:bg-neutral-950 sm:p-[12px] sm:shadow-[0_30px_90px_rgba(0,0,0,0.6)] relative">
        {/* Side buttons */}
        ...
        {/* Screen */}
        <div className="relative w-full h-screen sm:h-full sm:rounded-[2.6rem] overflow-hidden bg-background text-foreground">
          {/* Dynamic Island */}
