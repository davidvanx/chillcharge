...
export default function iPhoneFrame({ children }) {
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-neutral-900 to-black flex items-center justify-center p-2">
      {/* iPhone 17 Pro device frame — always visible, scales to fit */}
      <div className="w-[min(402px,96vw)] h-[min(874px,96vh)] rounded-[3.4rem] p-[3px] bg-gradient-to-b from-neutral-300 via-neutral-400 to-neutral-600 relative shadow-[0_40px_120px_rgba(0,0,0,0.6)]">
        {/* Titanium inner ring */}
