        ...
        <div className="px-5 pb-8">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              <h2 className="text-[22px] font-bold text-neutral-900 leading-tight">{station.name}</h2>
              <p className="text-[13px] text-neutral-500 mt-0.5 font-medium">{station.network}</p>
            </div>
            <button onClick={onClose} className="w-9 h-9 rounded-full bg-neutral-100 flex items-center justify-center active:scale-90 transition shrink-0">
          ...
          <div className="flex items-center gap-3 mt-3 text-[13px] text-neutral-600">
            <span className="flex items-center gap-1 bg-amber-50 px-2 py-1 rounded-full">
              ...
              <span className="font-bold text-amber-700">{station.rating?.toFixed(1)}</span>
            </span>
          ...
          <div className="mt-4 h-36 rounded-2xl bg-gradient-to-br from-neutral-100 to-neutral-200 flex items-center justify-center relative overflow-hidden">
            ...
            <div className={cn("w-16 h-16 rounded-3xl flex items-center justify-center shadow-xl", isDC ? "bg-violet-500" : "bg-sky-500")}>
          ...
          <div className="mt-4">
            ...
            <div className="h-2 rounded-full bg-neutral-100 overflow-hidden">
              <div
                className={cn("h-full rounded-full transition-all", ((station.total - station.available) / station.total) > 0.8 ? "bg-amber-400" : "bg-emerald-400")}
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {station.amenities.map((a) => {
                  ...
                  return (
                    <span key={a} className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-neutral-100 text-[12px] font-semibold text-neutral-700">
